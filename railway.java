...
public class railway {
    ...
    static String[] pp={"COVAI","TRIPUR","ERODE","SALEM","JOLARPETTAI","KATPADI","AMBUR","CHENNAI","covai","tripur","erode","salem","jolarpettai","katpadi","ambur","chennai"};
    //---------------------------------------//
   ...
   public static void book()
   {
    ...
    System.out.flush();
       ...
       System.out.println("1.COVAI||2.TRIPUR||3.ERODE||4.SALEM||5.JOLARPETTAI||6.KATPADI||7.AMBUR||8.CHENNAI CENTRAL");
       System.out.println();
...
public static void admin()
{
    ...
    String p1=sc.next();
    if(p.contains("SID")&&p1.contains(p1))
    {
